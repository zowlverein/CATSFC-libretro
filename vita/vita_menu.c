...
PL_MENU_OPTIONS_BEGIN(ScreenSizeOptions)
    PL_MENU_OPTION("1x original size", DISPLAY_MODE_UNSCALED)
    PL_MENU_OPTION("2x original size", DISPLAY_MODE_2X)
    PL_MENU_OPTION("Fill screen (height)", DISPLAY_MODE_FIT_HEIGHT)
    PL_MENU_OPTION("Fill screen (widescreen)", DISPLAY_MODE_FILL_SCREEN)
PL_MENU_OPTIONS_END
